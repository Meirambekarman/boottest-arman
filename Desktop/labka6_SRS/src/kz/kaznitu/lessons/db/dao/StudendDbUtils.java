...
public class StudendDbUtils {
    ...
    public List<Student> getStudents() throws Exception{
        ...
        try{
            ...
            while (myRst.next()){
                ...
                int phone_number = myRst.getInt("phone_number");
                String address = myRst.getString("address");
                student = new Student(id, firstName, lastName, email, phone_number, address) ;
    ...
    public void addStudent(Student student) throws Exception{
        ...
        try{
            myCon = dataSource.getConnection() ;
            String sql = "insert into student (first_name, last_name, email, phone_number, address)" +
                    " values " +
                    "(?, ?, ?, ?, ?)" ;
            ...
            myStmt.setInt(4, student.getPhone_number());
            myStmt.setString(5, student.getAddress());
            myStmt.execute() ;
    ...
    public Student loadStudent(String studId) throws Exception{
        ...
        try{
            ...
            if(myRst.next()){
                ...
                int phone_number = myRst.getInt("phone_number");
                String address = myRst.getString("address");
                student = new Student(studentId, firstName, lastName, email, phone_number, address) ;
                return student ;
