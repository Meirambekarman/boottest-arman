...
public class StudentControllerServlet extends HttpServlet{
    ...
    public void init() throws ServletException {
        ...
        try {
            ...
            dataSource = (DataSource)initialContext.lookup("java:comp/env/jdbc/arman") ;
    ...
    private void updateStudent(HttpServletRequest req, HttpServletResponse resp) {
        ...
        Student student = new Student(id, firstName, lastName, email, phone_number, address) ;
    ...
    private void addStudent(HttpServletRequest req, HttpServletResponse resp) {
        ...
        Student student = new Student(firstName, lastName, email, phone_number, address ) ;
